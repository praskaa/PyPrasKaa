# Blue Line Color Override

## Deskripsi

**Blue Line Color Override** adalah tool cepat untuk mengubah warna garis proyeksi dan pola pada elemen yang dipilih dalam view aktif. Tool ini mengatur override warna garis menjadi biru (RGB: 0, 0, 255) dengan pattern color override aktif.
...
- **Predefined Color**: Warna biru yang telah dioptimalkan untuk visibility
...
3. **Color Application**: Set projection line color ke blue (0, 0, 255)
...
### Basic Usage
1. Jalankan script dari Line Color panel → Colors2 stack → Blue
2. **Select Elements**: Pilih elemen yang ingin di-override (atau biarkan kosong untuk semua)
3. **Automatic Override**: Warna garis otomatis berubah menjadi biru
4. **Pattern Included**: Pattern fill juga menggunakan warna biru
...
- **Hex**: #0000FF
- **RGB**: (0, 0, 255)
- **Usage**: Optimal untuk structural elements dan primary information
- **Contrast**: High contrast untuk clear visibility
...
- **Color Coding**: Gunakan blue untuk structural atau primary elements
- **View Management**: Buat view khusus untuk overrides
- **Reset When Done**: Selalu reset overrides sebelum final plotting

### Workflow Integration
- **Presentation Prep**: Highlight structural elements dengan blue
- **Debugging**: Identifikasi primary elements dengan warna biru
- **Team Coordination**: Gunakan blue untuk main structural elements
- **Quality Control**: Visual check untuk structural integrity
...
setProjLines(0, 0, 255, True)  # Blue with pattern override
```

## Integration dengan Tools Lain

### Complementary Tools
- **Other Color Tools**: Azure, Magenta, Green untuk color coding
...
**PrasKaaPyKit - Line Color.panel/Colors2/Blue**
*Quick Blue Color Override untuk BIM Presentation*