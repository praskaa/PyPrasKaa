# Light Grey Line Color Override

## Deskripsi

**Light Grey Line Color Override** adalah tool cepat untuk mengubah warna garis proyeksi dan pola pada elemen yang dipilih dalam view aktif. Tool ini mengatur override warna garis menjadi abu-abu terang (RGB: 180, 180, 180) dengan pattern color override aktif.
...
- **Predefined Color**: Warna abu-abu terang yang telah dioptimalkan untuk visibility
...
3. **Color Application**: Set projection line color ke light grey (180, 180, 180)
...
### Basic Usage
1. Jalankan script dari Line Color panel → Colors3 stack → Light Grey
2. **Select Elements**: Pilih elemen yang ingin di-override (atau biarkan kosong untuk semua)
3. **Automatic Override**: Warna garis otomatis berubah menjadi abu-abu terang
4. **Pattern Included**: Pattern fill juga menggunakan warna abu-abu terang
...
### Light Grey Color Specification
- **Hex**: #B4B4B4
- **RGB**: (180, 180, 180)
- **Usage**: Optimal untuk background elements dan subtle highlighting
- **Contrast**: Low contrast untuk minimal visual impact
...
- **Color Coding**: Gunakan light grey untuk background atau de-emphasized elements
- **View Management**: Buat view khusus untuk overrides
- **Reset When Done**: Selalu reset overrides sebelum final plotting

### Workflow Integration
- **Presentation Prep**: De-emphasize background elements dengan light grey
- **Debugging**: Identify elements to be ignored dengan warna abu-abu terang
- **Team Coordination**: Gunakan light grey untuk elements yang sudah approved
- **Quality Control**: Visual check untuk background elements
...
setProjLines(180, 180, 180, True)  # Light Grey with pattern override
```

## Integration dengan Tools Lain

### Complementary Tools
- **Other Color Tools**: Grey, Reset, Green untuk color coding
...
**PrasKaaPyKit - Line Color.panel/Colors3/Light Grey**
*Quick Light Grey Color Override untuk BIM Presentation*